...
export const technologies: Technology[] = [
    // Frontend
    {
        ...
        category: 'Frontend',
        level: 85,
        description: 'Lenguaje principal para desarrollo web dinámico e interactivo',
        color: '#f7df1e',
        icon: 'JS',
        relatedProjects: ['The Good Trip', 'BigoteS Pizzeria', 'Wing House'],
    },
    {
        id: 'react',
        name: 'React',
        ...
        color: '#61dafb',
        icon: 'Re',
        relatedProjects: ['GMCO', 'ERP Tienda de Ropa', 'Portfolio'],
    },
    {
        id: 'typescript',
        name: 'TypeScript',
    ...
    },
    {
        ...
        color: '#e34f26',
        icon: 'H5',
        relatedProjects: ['Wing House', 'Tugu', 'BigoteS Pizzeria'],
    },
    // Backend
    {
        id: 'c-lang',
